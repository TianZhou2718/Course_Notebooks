...
<blockquote class="callout callout_default" theme="📘">
  ...
  <ul style="margin: 10px 0; padding-bottom: 0.25cm;">
    <li>Course Description: This is a course in the study of linear spaces, or vector spaces, and the structure of linear mappings between such spaces. Topics include vector spaces, the structure of linear transformations and matrices, eigenvalues and eigenvectors, the Jordan canonical form, inner product spaces and linear operators, and determinants.</li> <p>
    <li>Last Updated: Jan 14, 2024</li>
