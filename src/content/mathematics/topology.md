<div style="margin-top: 2rem; padding: 1.4rem 1.6rem; border-radius: 26px; background: linear-gradient(120deg, #eef1ff, #ffffff); border: 1px solid #d7ddff; box-shadow: 0 18px 35px rgba(76, 99, 185, 0.15); text-align: center;">
  <div style="font-size: 2.3rem; font-weight: 700; color: #1f2a4f; margin-top: 0.35rem;">Topology Notebooks</div>
</div>
...
<div class="notebook-card" style="margin: 0.85cm 0; padding: 1.25em 1.4em; border-radius: 18px; border: 1px solid #3457d533; background: #f5f7ff; box-shadow: 0 12px 30px rgba(15, 23, 42, 0.08);">
  <div style="display: flex; justify-content: space-between; flex-wrap: wrap; align-items: center; gap: 0.75rem;">
    <h3 style="margin: 0; font-size: 1.6rem; font-weight: 600;"> <a href="../../attachments/math_413_introduction_to_topology.pdf" style="color: inherit; text-decoration: none;"> 📘 &nbsp AS.110.413 Introduction to Topology</a></h3>
  </div>
  ...
  <div style="margin-top: 0.5em;">
    <p style="margin: 0 0 0.45em 0; font-size: 1.2rem; color: #3b3f45; line-height: 1.5;">Topological spaces, connectedness, compactness, quotient spaces, metric spaces, function spaces. An introduction to algebraic topology: covering spaces, the fundamental group, and other topics as time permits.</p>
  </div>
  <div style="margin-top: 0.95em; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.6rem;">
    <a href="../../attachments/math_413_introduction_to_topology.pdf" style="font-weight: 600; color: #3457d5; text-decoration: none;">View Notebook →</a>
